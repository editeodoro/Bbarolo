...
namespace PixelInfo
{
  ...
  public:
    ...
    friend std::ostream& operator<< (std::ostream& theStream, Object3D& obj);     /// Overloaded <<.
    friend Object3D operator+ (Object3D lhs, Object3D rhs);                       /// Overloaded +.
    ...
    void addPixel(long x, long y, long z);      /// Add a single 3-D voxel to the Object.
    template <class T>
    void addPixel(Voxel<T> v){addPixel(v.getX(),v.getY(),v.getZ());};
   
    void addScan(Scan s, long z);                           /// Add a scan to the object.  
    void addChannel(const long &z, Object2D &obj);       /// Add a full channel map to the Object. 
    ...
    Object2D getChanMap(long z);            /// Get the channel map for channel z.     
    Object2D getSpatialMap();               /// Return an Object2D with spatial (x,y) distribution of voxels.  
